...
#include <string>
#include <vector>
// Кузнечик прыгает по кувшинам, может передвигаться на 1, 2, 3 шага, сколько способов на n кувшину
// Сначала ищем количество способов попасть на 1, 2, 3 шаг, используем зависимость которую нашли и подправляем
using namespace std;
